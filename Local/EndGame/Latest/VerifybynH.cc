...
array<Double_e,3> nC_CS = {Double_e(0.00423111,5.34559e-05), Double_e(0.00600734, 6.11888e-05), Double_e(0.00703724, 7.81217e-05)};// syst vol ele rebin(100)
...
//const double correction = 0.1265;    // test
...
// MO spill-in
//const double nH_spillin = 0.98921954;
...
// dt
const Double_e nH_dteff(0.874204,0.0037643060);            // syst
const Double_e nC_dteff(0.870393,0.0037643060);           // syst
...
const array<Double_e,9> nC_acc = {Double_e(), Double_e(97.5211,2.52517), Double_e(108.508,2.56799), Double_e(107.402,0.876411),
...
const array<Double_e,9> nC_lkg = {Double_e(), Double_e(29730.4,60.227), Double_e(34307.8,62.386), Double_e(31334.2,147.255),
...
void VerifybynH(){
    ...
    cout << "nH eff = " << nH_eff << endl;
    cout << "nGd eff = " << nGd_eff << endl;
    cout << "Observed nH/nGd ratio = " << nH_evt.at(0)/nGd_evt.at(0) << endl;*/
    ...
    //const Double_e Hatom = w_GdLS*GdLS.GetHboth() + w_LS*LS.GetHboth() + w_acry*Acrylic.GetHboth();
    ...
    Double_e Hatom = w_GdLS*GdLS.GetHboth() + w_LS*LS.GetHboth() + w_acry*Acrylic.GetHboth();
    nH_eff.SetError(0);
    nGd_eff.SetError(0);
    ExpnH.SetError(0);
    ExpnGd.SetError(0);
    ...
    cout << "H atom = " << Hatom << endl;
    cout << "effH = " << nH_eff << endl;
    cout << "effGd = " << nGd_eff << endl;


    Double_e result = (nH_evt.at(0)/nGd_evt.at(0)) * (ExpnGd/Hatom) * (nGd_eff/nH_eff);


    cout << "Expected nH/nGd = " << ExpnH*nH_eff/ExpnGd/nGd_eff << endl;
    cout << "Measured nH/nGd = " << nH_evt.at(0)/nGd_evt.at(0) << endl;
    cout << "From nH/nGd : nH CS = " << result << endl;
