...
void FitterVerifybynH2(){
    ...
    minimizer->DefineParameter(1, "pull_acc_1", 0, 0.01, -0.1, 0.1);
    minimizer->DefineParameter(2, "pull_acc_2", 0, 0.01, -0.1, 0.1);
    minimizer->DefineParameter(3, "pull_acc_3", 0, 0.01, -0.1, 0.1);
    minimizer->DefineParameter(4, "pull_acc_4", 0, 0.01, -0.1, 0.1);
    minimizer->DefineParameter(5, "pull_lkg_1", 0, 0.01, -0.1, 0.1);
    minimizer->DefineParameter(6, "pull_lkg_2", 0, 0.01, -1, 1);
    minimizer->DefineParameter(7, "pull_lkg_3", 0, 0.01, -1, 1);
    minimizer->DefineParameter(8, "pull_lkg_4", 0, 0.01, -1, 1);
    minimizer->DefineParameter(9, "pull_GdLS_Gd_1", 0, 0.01, -0.1, 0.1);
    minimizer->DefineParameter(10, "pull_GdLS_Gd_2", 0, 0.01, -0.1, 0.1);
    minimizer->DefineParameter(11, "pull_GdLS_Gd_3", 0, 0.01, -0.1, 0.1);
    minimizer->DefineParameter(12, "pull_GdLS_Gd_4", 0, 0.01, -0.1, 0.1);
    minimizer->DefineParameter(13, "pull_GdLS_H_1", 0, 0.01, -0.1, 0.1);
    minimizer->DefineParameter(14, "pull_GdLS_H_2", 0, 0.01, -0.1, 0.1);
    minimizer->DefineParameter(15, "pull_GdLS_H_3", 0, 0.01, -0.1, 0.1);
    minimizer->DefineParameter(16, "pull_GdLS_H_4", 0, 0.01, -0.1, 0.1);
    minimizer->DefineParameter(17, "pull_GdLS_C_1", 0, 0.01, -0.1, 0.1);
    minimizer->DefineParameter(18, "pull_GdLS_C_2", 0, 0.01, -0.1, 0.1);
    minimizer->DefineParameter(19, "pull_GdLS_C_3", 0, 0.01, -0.1, 0.1);
    minimizer->DefineParameter(20, "pull_GdLS_C_4", 0, 0.01, -0.1, 0.1);
    minimizer->DefineParameter(21, "pull_LS_H_1", 0, 0.01, -0.1, 0.1);
    minimizer->DefineParameter(22, "pull_LS_H_2", 0, 0.01, -0.1, 0.1);
    minimizer->DefineParameter(23, "pull_LS_H_3", 0, 0.01, -0.1, 0.1);
    minimizer->DefineParameter(24, "pull_LS_H_4", 0, 0.01, -0.1, 0.1);
    minimizer->DefineParameter(25, "pull_LS_C_1", 0, 0.01, -0.1, 0.1);
    minimizer->DefineParameter(26, "pull_LS_C_2", 0, 0.01, -0.1, 0.1);
    minimizer->DefineParameter(27, "pull_LS_C_3", 0, 0.01, -0.1, 0.1);
    minimizer->DefineParameter(28, "pull_LS_C_4", 0, 0.01, -0.1, 0.1);
    minimizer->DefineParameter(29, "pull_eff_H_corr", 0, 0.01, -0.1, 0.1);
    minimizer->DefineParameter(30, "pull_eff_H_uncorr_1", 0, 0.01, -0.1, 0.1);
    minimizer->DefineParameter(31, "pull_eff_H_uncorr_2", 0, 0.01, -0.1, 0.1);
    minimizer->DefineParameter(32, "pull_eff_H_uncorr_3", 0, 0.01, -0.1, 0.1);
    minimizer->DefineParameter(33, "pull_eff_H_uncorr_4", 0, 0.01, -0.1, 0.1);
    minimizer->DefineParameter(34, "pull_eff_Gd_corr", 0, 0.01, -0.1, 0.1);
    minimizer->DefineParameter(35, "pull_eff_Gd_uncorr_1", 0, 0.01, -0.1, 0.1);
    minimizer->DefineParameter(36, "pull_eff_Gd_uncorr_2", 0, 0.01, -0.1, 0.1);
    minimizer->DefineParameter(37, "pull_eff_Gd_uncorr_3", 0, 0.01, -0.1, 0.1);
    minimizer->DefineParameter(38, "pull_eff_Gd_uncorr_4", 0, 0.01, -0.1, 0.1);
    minimizer->DefineParameter(39, "pull_cs_H_GdLS", 0, 0.01, -0.1, 0.1);
    minimizer->DefineParameter(40, "pull_cs_H_LS", 0, 0.01, -0.1, 0.1);
    minimizer->DefineParameter(41, "pull_cs_H_acry", 0, 0.01, -0.1, 0.1);
    minimizer->DefineParameter(42, "pull_cs_Gd155", 0, 0.01, -0.1, 0.1);
    minimizer->DefineParameter(43, "pull_cs_Gd157", 0, 0.01, -0.1, 0.1);
    minimizer->DefineParameter(44, "pull_cs_C_GdLS", 0, 0.01, -0.1, 0.1);
    minimizer->DefineParameter(45, "pull_cs_C_LS", 0, 0.01, -0.1, 0.1);
    minimizer->DefineParameter(46, "pull_cs_C_acry", 0, 0.01, -0.1, 0.1);
    //minimizer->FixParameter(29);
    //minimizer->FixParameter(34);
