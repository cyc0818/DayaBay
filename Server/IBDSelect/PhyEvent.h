...
const long long startT=1324339200;
...
PhyEvent::PhyEvent(CalibStats &calst, AdSimple &adrec) {
	...
	trigTime_s = adrec.triggerTimeSec-startT;
	...
	isIWSMu = (detector==5)&&calst.nHit>12;
	isOWSMu = (detector==6)&&calst.nHit>12;
	isADMu = (detector<=4)&&(calst.NominalCharge>3000)&&(calst.NominalCharge<300000);
	isSHMu = (detector<=4)&&(calst.NominalCharge>300000);
	isMulow = (detector<=4)&&(calst.NominalCharge>3000)&&(calst.NominalCharge<100000);
	isMumid = (detector<=4)&&(calst.NominalCharge>100000)&&(calst.NominalCharge<300000);
}
