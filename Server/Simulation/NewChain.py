...
class ConfigureFullChain:
    ...
    def configureKinematic(self):
        #IBD
        from MDC09b.runIBD15.IBD import EvtGenerator
#        from IBD import EvtGenerator
        ibd_oil = EvtGenerator(stage    = self.stage_cfg,
                               name     = 'IBD_oil',
                               seed     = self.opts.seed,
...
#                               strategy = 'Material',
        ...
        ibd_gds = EvtGenerator(stage    = self.stage_cfg,
                               name     = 'IBD_gds',
                               seed     = self.opts.seed,
                               volume   = '/dd/Structure/AD/db-oil1',
                               strategy = 'Material',
        ...
        ibd_lso = EvtGenerator(stage    = self.stage_cfg,
                               name     = 'IBD_lso',
                               seed     = self.opts.seed,
                               volume   = '/dd/Structure/AD/db-oil1',
                               strategy = 'Material',
        ...
        ibd_acrylic = EvtGenerator(stage    = self.stage_cfg,
                                   name     = 'IBD_acrylic',
                                   seed     = self.opts.seed,
                                   volume   = '/dd/Structure/AD/db-oil1',
                                   strategy = 'Material',
...
#        from Radioact import Radioact
        #U238
        u238_gds = Radioact(stage      = self.stage_cfg,
                            name       = 'U238_gds',
                            volume     = '/dd/Structure/AD/db-oil1',
                            nuclide    = 'U238',
                            abundance  = 5.06e16,
        ...
        u238_lso = Radioact(stage      = self.stage_cfg,
                            name       = 'U238_lso',
                            volume     = '/dd/Structure/AD/db-oil1',
                            nuclide    = 'U238',
                            abundance  = 5.43e16,
        ...
        u238_PMT = Radioact(stage      = self.stage_cfg,
                            name       = 'U238_PMT',
                            volume     = '/dd/Structure/AD/db-oil1',
                            nuclide    = 'U238',
                            abundance  = 6.45e19,
        ...
        u238_sst = Radioact(stage      = self.stage_cfg,
                            name       = 'U238_sst',
        ...
        #Th232
        th232_gds = Radioact(stage      = self.stage_cfg,
                             name       = 'Th232_gds',
                             volume     = '/dd/Structure/AD/db-oil1',
                             nuclide    = 'Th232',
                             abundance  = 5.19e16,
        ...
        th232_lso = Radioact(stage      = self.stage_cfg,
                             name       = 'Th232_lso',
                             volume     = '/dd/Structure/AD/db-oil1',
                             nuclide    = 'Th232',
                             abundance  = 5.57e16,
        ...
        th232_PMT = Radioact(stage      = self.stage_cfg,
                             name       = 'Th232_PMT',
                             volume     = '/dd/Structure/AD/db-oil1',
                             nuclide    = 'Th232',
                             abundance  = 1.28e20,
        ...
        th232_sst = Radioact(stage      = self.stage_cfg,
                             name       = 'Th232_sst',
                             volume     = '/dd/Structure/AD/db-ade1',
                             nuclide    = 'Th232',
                             abundance  = 7.22e19,
        ...
        #K40
        k40_gds = Radioact(stage      = self.stage_cfg,
                           name       = 'K40_gds',
                           volume     = '/dd/Structure/AD/db-oil1',
                           nuclide    = 'K40',
                           abundance  = 3.01e17,
        ...
        k40_lso = Radioact(stage      = self.stage_cfg,
                           name       = 'K40_lso',
                           volume     = '/dd/Structure/AD/db-oil1',
                           nuclide    = 'K40',
                           abundance  = 3.23e17,
        ...
        k40_PMT = Radioact(stage      = self.stage_cfg,
                           name       = 'K40_PMT',
                           volume     = '/dd/Structure/AD/db-oil1',
                           nuclide    = 'K40',
                           abundance  = 3.91e19,
        ...
        k40_sst = Radioact(stage      = self.stage_cfg,
                           name       = 'K40_sst',
                           volume     = '/dd/Structure/AD/db-ade1',
                           nuclide    = 'K40',
                           abundance  = 1.44e19,
    ...
    def configureDetector(self):
        ...
        # --- adapt to changes in r10935 that replace CerenPhotonScaleWeight, etc.
        #optical.PreQE = 0.32
        #optical.ApplyPreQE = True
        # return back after rev.12337
        optical.CerenPhotonScaleWeight=3.125
        optical.ScintPhotonScaleWeight=3.125
        
        ## ......
        ## ApplyWaterQe and WaterCerenQeApplied should be same
        # r10935 : optical.ApplyWaterQe = True
        # ApplyWaterQe is set by default after rev.12337
        from DetSim.DetSimConf import DsPmtSensDet
        pmtsd = DsPmtSensDet("GiGaGeo.DsPmtSensDet")
        # r10935 : pmtsd.WaterCerenQeApplied = optical.ApplyWaterQe
        ...
        ds.unobserver(stats=[
                ...
                ["capTargetMass", "capTargetA","%(NCap)s and %(track2)s"%params],
