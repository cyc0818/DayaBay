...
if __name__ == "__main__":
    ...
    nowDir = os.getcwd()
    site = "EH3"
    DataList = "/dybfs2/users/yuchincheng/workdir/IBD/data/P21A/"+site+"/EvtSelect/"
    AppDir = "/dybfs2/users/yuchincheng/workdir/IBD/code/IBD_plotting"
    OutputDir = "/dybfs2/users/yuchincheng/workdir/IBD/data/P21A/"+site+"/Plots/"
	...
	FILE0.close()
        ...
        os.system( "/afs/ihep.ac.cn/soft/common/sysgroup/hep_job/bin/hep_sub -os SL6 "+cshfile )
