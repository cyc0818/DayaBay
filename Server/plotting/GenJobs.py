...
if __name__ == "__main__":
    ...
    nowDir = os.getcwd()
    site = "EH3"
    DataList = "/dybfs2/users/yuchincheng/workdir/IBD/data/P17B/"+site+"/Pairs/"
    AppDir = "/dybfs2/users/yuchincheng/workdir/IBD/code/plotting"
	...
	FILE0.close()
        ...
        os.system( "/afs/ihep.ac.cn/soft/common/sysgroup/hep_job/bin/hep_sub -mem 4500 "+cshfile )
