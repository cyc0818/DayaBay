##  -*- python -*-  
# db file automatically generated by genconf on: Wed Jul 20 16:50:31 2022
...
def _fillCfgDb():
    ...
    cfgDb.add( configurable = 'MyPromptEfficiencyAlg',
               package = 'MyPromptEfficiencyAlg',
               module  = 'MyPromptEfficiencyAlg.MyPromptEfficiencyAlgConf',
               lib     = 'MyPromptEfficiencyAlg' )
    return #_fillCfgDb
...
try:
    ...
    print "Py:ConfigurableDb   ERROR   ==> culprit is package [MyPromptEfficiencyAlg] !"
