...
Observables::Observables(){
    ...
    //object_map = { {&HistogramPackage::h_ed,m_ed} };
    object_map = { {&HistogramPackage::h_ep,m_ep} };
    //object_map = { {&HistogramPackage::h_dt,m_dt} };

    vertex_map = { {&HistogramPackage::h_rz_t, m_vtxd_t} };
...
bool FormatPA::BasicCheck(){
    ...
    bool judge = true;
    //array<int,6> captogen = {-50,2,3,1,3,0};
    //if(genType != captogen.at(capVol)) judge = false;
...
vector<bool (Observables::*)()> cut_seq = {&Observables::EdCut, &Observables::EpCut,
                                           &Observables::DistanceCut, &Observables::TimeIntervalCut};
