  ...
  :Invalid(0)
{
  ...
  m_tree->Branch( "GenDet",         &GenDet,             "GenDet/I"         );
  m_tree->Branch( "CapDet",         &CapDet,             "CapDet/I"         );
  m_tree->Branch( "EkInit",         &EkInit,             "EkInit/D"         );
  m_tree->Branch( "EkBfCap",        &EkBfCap,            "EkBfCap/D"         );
  m_tree->Branch( "EkMean",         &EkMean,             "EkMean/D"         );
}
