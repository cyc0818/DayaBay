##  -*- python -*-  
# db file automatically generated by genconf on: Sun Jan 23 18:49:22 2022
...
def _fillCfgDb():
    ...
    cfgDb.add( configurable = 'ExamTruth',
               package = 'ExamTruth',
               module  = 'ExamTruth.ExamTruthConf',
               lib     = 'ExamTruth' )
    return #_fillCfgDb
...
try:
    ...
    print "Py:ConfigurableDb   ERROR   ==> culprit is package [ExamTruth] !"
