#Sun Jan 23 18:49:22 2022
"""Automatically generated. DO NOT EDIT please"""
from GaudiKernel.Proxy.Configurable import *

class ExamTruth( ConfigurableAlgorithm ) :
  __slots__ = { 
    'OutputLevel' : 0, # int
    'Enable' : True, # bool
    'ErrorMax' : 1, # int
  ...
  _propertyDocDct = { 
    ...
    'RootFile' : """ Output root file name """,
    'XYZCorr' : """ By default no correction """,
  ...
  def __init__(self, name = Configurable.DefaultName, **kwargs):
      super(ExamTruth, self).__init__(name)
