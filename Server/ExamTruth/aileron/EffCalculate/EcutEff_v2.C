...
*/	
	...
	char n3sigmaPCut[200], n3sigmaDCut[200], n3sigmaTimeCut[200], n3sigmaDCut0[200], n3sigmaTimeCut0[200];
    ...
    char onlyEnCut_T0[200], onlyEnCut_T[200];
        ...
        sprintf(TimeCut, "E[0]*%f>%f && CapTarget==%d && GenDet==%1d && ((TrigSecT[1]-TrigSecT[0])+(TrigNanoT[1]-TrigNanoT[0])*1e-9)<%f ", EpScaleF, cutEp, 1, detID, 0.0004);
        sprintf(dCut, "E[0]*%f>%f && CapTarget==%d && GenDet==%1d && ((TrigSecT[1]-TrigSecT[0])+(TrigNanoT[1]-TrigNanoT[0])*1e-9)<%f && D2First[1]<%f", EpScaleF, cutEp, 1, detID, 0.0004,500);
	...
	new TCanvas;
        ...
        sprintf(onlyEnCut_T, "E[1]*%f>%f && E[1]*%f<%f && CapTarget ==%d && GenDet==%1d && ((TrigSecT[1]-TrigSecT[0])+(TrigNanoT[1]-TrigNanoT[0])*1e-9)<%f ", scaleF, cutB, scaleF, cutT, 1, detID, 0.0004);
    ...
    float NEd_T11 = h_EdT1->Integral(1,401);
        ...
        sprintf(n3sigmaTimeCut, "E[1]*%f>%f && E[1]*%f<%f && E[0]*%f>%f && CapTarget ==%d && GenDet==%1d && ((TrigSecT[1]-TrigSecT[0])+(TrigNanoT[1]-TrigNanoT[0])*1e-9)<%f ", scaleF, cutB, scaleF, cutT, EpScaleF,cutEp,1, detID, 0.0004);
        sprintf(n3sigmaDCut, "E[1]*%f>%f && E[1]*%f<%f && E[0]*%f>%f && CapTarget ==%d && GenDet==%1d && ((TrigSecT[1]-TrigSecT[0])+(TrigNanoT[1]-TrigNanoT[0])*1e-9)<%f && D2First[1]<%f",scaleF, cutB,scaleF, cutT,EpScaleF, cutEp,1,detID, 0.0004, 500);
    
        sprintf(n3sigmaPCut, "E[1]*%f>%f && E[1]*%f<%f && E[0]*%f>%f && GenDet==%1d", scaleF, cutB, scaleF, cutT, EpScaleF, cutEp, detID);
        sprintf(n3sigmaTimeCut, "E[1]*%f>%f && E[1]*%f<%f && E[0]*%f>%f && GenDet==%1d && ((TrigSecT[1]-TrigSecT[0])+(TrigNanoT[1]-TrigNanoT[0])*1e-9)<%f ", scaleF, cutB, scaleF, cutT, EpScaleF,cutEp,detID, 0.0004);
